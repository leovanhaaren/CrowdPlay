...
public class ContributorMusicOverviewActivity extends Activity implements AdapterView.OnItemClickListener {

    private static final String TAG = "ContributorMusicOverviewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_music_overview);
